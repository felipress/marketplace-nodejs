...
router.post("/addFavoriteProduct/:id", authMiddleware, validateIdParams, validateIdBody, userController.addUserFavoriteProduct)
...
router.delete("/removeFavoriteProduct/:id", validateIdParams, authMiddleware, userController.removeUserFavoriteProduct)
